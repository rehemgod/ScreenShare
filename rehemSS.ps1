...
Write-Host -ForegroundColor Cyan " // || ____  _____ _   _ _____ __  __      ____ ____  ||"
Write-Host -ForegroundColor Cyan " // |||  _ \| ____| | | | ____|  \/  |    / ___/ ___| ||"
Write-Host -ForegroundColor Cyan " // ||| |_) |  _| | |_| |  _| | |\/| |    \___ \___ \ ||"
Write-Host -ForegroundColor Cyan " // |||  _ <| |___|  _  | |___| |  | |     ___) |__) |||"
Write-Host -ForegroundColor Cyan " // |||_| \_\_____|_| |_|_____|_|  |_|    |____/____/ ||"
Write-Host -ForegroundColor Cyan " // >>================================================<<"

Write-Host ""
Write-Host -ForegroundColor Cyan "Juro que voy a respetar esta SS Tool creada por REHEM, te agradezco por pasarla."
Write-Host ""
